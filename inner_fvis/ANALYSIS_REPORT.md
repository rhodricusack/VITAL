...
- Figure 1.1: Layer 2.2 Neuron Features Across Blur Levels
- Figure 1.2: Layer 3.2 Neuron Features Across Blur Levels
- Figure 1.3: Layer 4.2 Neuron Features Across Blur Levels
- Figure 1.4a: Representative Neurons - Layer 2.2 (Early Features)
- Figure 1.4b: Representative Neurons - Layer 3.2 (Mid-Level Features)
- Figure 1.4c: Representative Neurons - Layer 4.2 (High-Level Features)
...
- Columns: Different neurons 
- Each cell: 4×4 mosaic of top activating patches

#### Figure 1.1: Layer 2.2 Neuron Features Across Blur Levels
![Layer 2.2 Visualization Grid](visualization_grids/all_neurons_grid_layer2.2.png)
*Early layer feature preferences across different training blur conditions. Each row represents a different blur level (σ), each column a different neuron.*
